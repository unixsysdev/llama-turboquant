        ...
        case GGML_OP_SET_ROWS:
            {
                return (op->type == GGML_TYPE_F32 || op->type == GGML_TYPE_F16 || op->type == GGML_TYPE_BF16 ||
                       ...
                       op->type == GGML_TYPE_TQ3_0 || op->type == GGML_TYPE_TQ3_0V) &&
        ...
        case GGML_OP_CPY:
            {
                ...
                if (src0_type == GGML_TYPE_F32 && src1_type == GGML_TYPE_TQ3_0V) {
                    return true;
                }
                if (src0_type == GGML_TYPE_TQ3_0V && src1_type == GGML_TYPE_F32) {
                    return true;
                }
